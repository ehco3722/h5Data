...
/******/ 	__webpack_require__.p = "http://localhost:8090/out/";
...
/***/ function(module, exports, __webpack_require__) {
	...
	let Manage = __webpack_require__(4);
	let data = [['js', 0.3, '#aa5566'], ['h5', 0.2, '#6677aa'], ['css3', 0.1, '#b22443'], ['jq', 0.3, '#998aac'], ['rt', 0.1, '#ccc113']];

	Manage.init().addPage('onePage').addComponent({
	    type: 'base',
	    width: 428,
	    height: 92,
	    center: true,
	...
	.addPage('twoPage').addComponent({
	    ...
	    delay: 1500
	}).addPage('threePage').addComponent({
	    width: 500,
	    height: 124,
	    css: {
	        position: 'absolute',
...
/***/ function(module, exports, __webpack_require__) {
	...
	let ComponentBaseFacotry = __webpack_require__(11);
	let ComponentBarFacotry = __webpack_require__(14);
	let ComponentPolyLineFactory = __webpack_require__(17);
	let ComponentPieFactory = __webpack_require__(20);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/less-loader/index.js!./initial.less", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/less-loader/index.js!./initial.less");
...
/***/ function(module, exports, __webpack_require__) {
	...
	let ComponentBaseFactory = __webpack_require__(11);
	let ComponentBarFactory = config => {
	        ...
	        Data.forEach((ele, index) => {
	                ...
	                itemWrapper.append(nameDiv).append(loadWrapper).append(perDiv).appendTo(Component);
	        });
	        return Component;
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".ComponentBar .itemWrapper {\n  height: 25px;\n  margin-top: 20px;\n  line-height: 25px;\n  text-align: center;\n}\n.ComponentBar .itemWrapper .name {\n  float: left;\n  width: 40px;\n  height: 25px;\n  margin-right: 10px;\n}\n.ComponentBar .itemWrapper .loadWrapper {\n  float: left;\n  height: 25px;\n  margin-right: 10px;\n}\n.ComponentBar .itemWrapper .loadWrapper .loadInner {\n  width: 0%;\n  opacity: 0;\n  height: 25px;\n  border-radius: 8%;\n  transition: all 1s ease-in-out;\n}\n.ComponentBar .itemWrapper .percent {\n  float: left;\n  height: 25px;\n  opacity: 0;\n  transition: all 1s ease-in-out 1s;\n}\n.load .itemWrapper .loadWrapper .loadInner {\n  width: 100%;\n  opacity: 1;\n}\n.load .itemWrapper .percent {\n  opacity: 1;\n}\n.leave .itemWrapper .loadWrapper .loadInner {\n  width: 0%;\n  opacity: 0;\n}\n.leave .itemWrapper .percent {\n  opacity: 0;\n}\n", ""]);
